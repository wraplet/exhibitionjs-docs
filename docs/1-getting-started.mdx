...
<div data-js-exhibition>
  <div data-js-exhibition__editor data-js-options='{"monacoOptions": {"language": "html"}}'></div>
  <button data-js-exhibition__updater>Update</button>
  <iframe data-js-exhibition__preview></iframe>
</div>
```
